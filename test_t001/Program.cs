...
//задачи на 2 спринт
//Реализация теста Т002: (а) распаковка (расшифрование) файла(ов) обновления безопасности;
//б) определение критериев проверки подлинности файла(ов) обновления безопасности.
//В качестве критериев проверки подлинности файла(ов) обновления могут выступать контрольные суммы файлов,
//электронная цифровая подпись файлов или иные критерии проверки подлинности файла(ов) обновления безопасности, предоставляемые его разработчиком)

//Реализация теста Т003: (а)проверка обновлений безопасности средствами антивирусной защиты до их установки;